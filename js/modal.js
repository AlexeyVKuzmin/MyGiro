class ItcModal {
  #elem;
  #template = '<div class="itc-modal-backdrop"><div class="itc-modal-content itc-modal-scrollable"><div class="itc-modal-header"><div class="itc-modal-title">{{title}}</div><span class="itc-modal-btn-close" style="color:red; font-size:50px" title="Закрыть">&#10008;</span></div><div class="itc-modal-body">{{content}}</div>{{footer}}</div></div>';
