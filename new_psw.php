...
<html lang="ru">
<head>
<title>MY-GIRO. Новый пароль</title>
<meta charset="utf-8">
...
<div class="reg">
<p align="center"><font size="+3">Новый пароль</font></p>
...
<br><input  id="password1" name="password1"   placeholder=" Повторите пароль " type="password" >
<p><button class="header-button" type="submit"  id="but_reg" onClick="getR()" title="Новый пароль"> Сохранить </button>
<div id="message"></div>
...
if (document.querySelector('#email').value=="" || document.querySelector('#password').value=="" || document.querySelector('#password1').value=="")	
	{
document.querySelector('#message').innerHTML = "<p class='red'><b>Заполните поля!</b></p>";
	...
	if(reg.test(mail) == false)
			...
			{document.querySelector('#message').innerHTML = "<p class='red'><b>Пароли не совпадают</b></p>";
			}

		else{
	document.querySelector('#message').innerHTML = "<img src='images/loader.gif'>Идет процесс сохранения нового пароля";
